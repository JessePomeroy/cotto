...
export interface components {
    schemas: {
        ...
        /** @enum {string} */
        GenerationStatus: "receiving" | "queued" | "transcribing" | "proofreading" | "completed" | "failed" | "cancelled";
        /** @enum {string} */
        AudioKind: "inference" | "original";
        /** @enum {string} */
        WisprFlowArtifactName: "source.json" | "source.wav" | "opus.json" | "screenshot.png" | "built-in-audio.bin";
        /** @enum {string} */
        WisprFlowImportOutcome: "imported" | "enriched" | "skipped" | "partial";
        /** @enum {string} */
        TextProcessingStatus: "disabled" | "unavailable" | "applied" | "unchanged" | "rejected" | "failed" | "skipped";
        /** @enum {string} */
        ...
        ServerPreferences: {
            /** @enum {string} */
            language: "en" | "auto" | "es" | "fr" | "de" | "it" | "pt" | "nl" | "ja" | "zh" | "ko" | "hi" | "ar" | "pl" | "ru" | "uk" | "sv";
...
export interface operations {
    ...
    downloadArtifact: {
        parameters: {
            ...
            path: {
                id: components["schemas"]["UUID"];
                filename: "inference.wav" | "original.wav" | "metadata.json" | "transcript.txt" | "source.json" | "source.wav" | "opus.json" | "screenshot.png" | "built-in-audio.bin";
            };
            cookie?: never;
        };
        requestBody?: never;
